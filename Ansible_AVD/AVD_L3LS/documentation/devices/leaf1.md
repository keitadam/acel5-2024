...
| --------- | --------------- | ------------ | --------- |
| mlag1 | Vlan4094 | 10.255.252.1 | Port-Channel1 |
...
| Ethernet7 | host1_Ethernet1 | *access | *10 | *- | *- | 7 |
...
| 192.168.103.6 | 65001 | default | - | Inherited from peer group IPv4-UNDERLAY-PEERS | Inherited from peer group IPv4-UNDERLAY-PEERS | - | - | - | - | - |
